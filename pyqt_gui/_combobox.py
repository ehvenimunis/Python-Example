...
class Window(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        # combobox içerisine eleman ekleme
        ...
        self.ui.cbSehirler.currentIndexChanged.connect(
            self.SelectedChangedIndex)
        self.ui.cbSehirler.currentIndexChanged[str].connect(
            self.SelectedChangedText)

    def ClearItems(self):
        self.ui.cbSehirler.clear()

    def LoadItems(self):
        sehirler = ['Adana', 'İzmir', 'Rize']  # elemanları yükler

        self.ui.cbSehirler.addItems(sehirler)

    def GetItem(self):  # seçili olan eleman için tex bilgisi verir
